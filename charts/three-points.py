...
# Parameters for the 3-point figure chart
point_increment = 0.001  # Define a "full point" for forex
reversal_threshold = 3 * point_increment  # 3 points for reversal
...
plt.title("3-Point Figure Chart for EUR/USD")
plt.xlabel("Columns")
plt.ylabel("Price")
plt.grid()
plt.show()
